...
/* Casja principal donde esta todas las img y links */
#caja {
  width: auto;
...
/* Seccion de la primera parte, donde es generar el codigo QR */
#Generar-QR {
  width: auto;
  padding: 1rem;
  border-radius: 20px;
